...
export default function getSubNodes(
  head: unknown,
...
function shouldNodeBeIncluded(
  node: unknown,
): node is Record<string, unknown> | Iterable<unknown> {
