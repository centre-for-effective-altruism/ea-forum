...
export class ClaimsPlugin extends Plugin {
  init() {
    ...
    this.editor.ui.componentFactory.add("insertClaimButton", (locale) => {
      const command = this.editor.commands.get("insertClaim");
  ...
  _defineConverters() {
    const config = this.editor.config.get("claims");
          ...
          (domElement) => {
            ...
            (_a =
              config === null || config === void 0
                ? void 0
                : config.renderClaimPreviewInto) === null || _a === void 0
              ? void 0
              : _a.call(config, domElement, claimId);
          },
        );
        return toWidget(
          downcastWriter.createContainerElement("div", {}, [reactWrapper]),
          downcastWriter,
        );
      },
    });
